            ...
            <ul class="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse nav-collapse {{ request()->routeIs('demo-blade.*') ? 'show' : '' }}" id="demoBlade">
                        <li class="nav-item">
                            <a href="{{ route('demo-blade.index') }}" class="nav-link {{ request()->routeIs('demo-blade.index') ? 'active' : '' }}">
                                <i class="bi bi-house"></i> Overview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('demo-blade.directives') }}" class="nav-link {{ request()->routeIs('demo-blade.directives') ? 'active' : '' }}">
                                <i class="bi bi-signpost-split"></i> Directives
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('demo-blade.components') }}" class="nav-link {{ request()->routeIs('demo-blade.components') ? 'active' : '' }}">
                                <i class="bi bi-puzzle"></i> Components
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('demo-blade.includes') }}" class="nav-link {{ request()->routeIs('demo-blade.includes') ? 'active' : '' }}">
                                <i class="bi bi-box-arrow-in-right"></i> Include & Each
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('demo-blade.stacks') }}" class="nav-link {{ request()->routeIs('demo-blade.stacks') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse nav-collapse {{ request()->routeIs('xss-lab.*') ? 'show' : '' }}" id="xssLab">
                        <li class="nav-item">
                            <a href="{{ route('xss-lab.index') }}" class="nav-link {{ request()->routeIs('xss-lab.index') ? 'active' : '' }}">
                                <i class="bi bi-house"></i> Overview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('xss-lab.reflected.vulnerable') }}" class="nav-link text-danger {{ request()->routeIs('xss-lab.reflected.vulnerable') ? 'active' : '' }}">
                                <i class="bi bi-unlock"></i> Reflected (Vuln)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('xss-lab.reflected.secure') }}" class="nav-link text-success {{ request()->routeIs('xss-lab.reflected.secure') ? 'active' : '' }}">
                                <i class="bi bi-lock"></i> Reflected (Secure)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('xss-lab.stored.vulnerable') }}" class="nav-link text-danger {{ request()->routeIs('xss-lab.stored.vulnerable') ? 'active' : '' }}">
                                <i class="bi bi-unlock"></i> Stored (Vuln)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('xss-lab.stored.secure') }}" class="nav-link text-success {{ request()->routeIs('xss-lab.stored.secure') ? 'active' : '' }}">
                                <i class="bi bi-lock"></i> Stored (Secure)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('xss-lab.dom.vulnerable') }}" class="nav-link text-danger {{ request()->routeIs('xss-lab.dom.vulnerable') ? 'active' : '' }}">
                                <i class="bi bi-unlock"></i> DOM-Based (Vuln)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('xss-lab.dom.secure') }}" class="nav-link text-success {{ request()->routeIs('xss-lab.dom.secure') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse nav-collapse {{ request()->routeIs('validation-lab.*') ? 'show' : '' }}" id="validationLab">
                        <li class="nav-item">
                            <a href="{{ route('validation-lab.index') }}" class="nav-link {{ request()->routeIs('validation-lab.index') ? 'active' : '' }}">
                                <i class="bi bi-house"></i> Overview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('validation-lab.vulnerable') }}" class="nav-link text-danger {{ request()->routeIs('validation-lab.vulnerable') ? 'active' : '' }}">
                                <i class="bi bi-unlock"></i> Vulnerable Form
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('validation-lab.secure') }}" class="nav-link text-success {{ request()->routeIs('validation-lab.secure') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse nav-collapse {{ request()->routeIs('csrf-lab.*') ? 'show' : '' }}" id="csrfLab">
                        <li class="nav-item">
                            <a href="{{ route('csrf-lab.index') }}" class="nav-link {{ request()->routeIs('csrf-lab.index') ? 'active' : '' }}">
                                <i class="bi bi-house"></i> Overview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('csrf-lab.how-it-works') }}" class="nav-link text-info {{ request()->routeIs('csrf-lab.how-it-works') ? 'active' : '' }}">
                                <i class="bi bi-lightbulb"></i> How It Works
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('csrf-lab.attack-demo') }}" class="nav-link text-danger {{ request()->routeIs('csrf-lab.attack-demo') ? 'active' : '' }}">
                                <i class="bi bi-bug"></i> Attack Demo
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('csrf-lab.protection-demo') }}" class="nav-link text-success {{ request()->routeIs('csrf-lab.protection-demo') ? 'active' : '' }}">
                                <i class="bi bi-shield-check"></i> Protection Demo
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('csrf-lab.ajax-demo') }}" class="nav-link text-warning {{ request()->routeIs('csrf-lab.ajax-demo') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse nav-collapse {{ request()->routeIs('sqli-lab.*') ? 'show' : '' }}" id="sqliLab">
                        <li class="nav-item">
                            <a href="{{ route('sqli-lab.index') }}" class="nav-link {{ request()->routeIs('sqli-lab.index') ? 'active' : '' }}">
                                <i class="bi bi-house"></i> Overview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sqli-lab.how-it-works') }}" class="nav-link text-info {{ request()->routeIs('sqli-lab.how-it-works') ? 'active' : '' }}">
                                <i class="bi bi-lightbulb"></i> How It Works
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sqli-lab.vulnerable-search') }}" class="nav-link text-danger {{ request()->routeIs('sqli-lab.vulnerable-search') ? 'active' : '' }}">
                                <i class="bi bi-search"></i> Vulnerable Search
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sqli-lab.vulnerable-login') }}" class="nav-link text-danger {{ request()->routeIs('sqli-lab.vulnerable-login') ? 'active' : '' }}">
                                <i class="bi bi-key"></i> Login Bypass
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sqli-lab.secure-search') }}" class="nav-link text-success {{ request()->routeIs('sqli-lab.secure-search') ? 'active' : '' }}">
                                <i class="bi bi-shield-check"></i> Secure Search
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sqli-lab.cheatsheet') }}" class="nav-link {{ request()->routeIs('sqli-lab.cheatsheet') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse nav-collapse {{ request()->routeIs('auth-lab.*') || request()->routeIs('login') || request()->routeIs('register') || request()->routeIs('vulnerable.*') ? 'show' : '' }}" id="authLab">
                        <li class="nav-item">
                            <a href="{{ route('auth-lab.index') }}" class="nav-link {{ request()->routeIs('auth-lab.index') ? 'active' : '' }}">
                                <i class="bi bi-house"></i> Overview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('auth-lab.comparison') }}" class="nav-link text-info {{ request()->routeIs('auth-lab.comparison') ? 'active' : '' }}">
                                <i class="bi bi-arrows-angle-expand"></i> Comparison
                            </a>
                        </li>
                        {{-- Secure Auth --}}
                        <li class="nav-item">
                            <a href="{{ route('login') }}" class="nav-link text-success {{ request()->routeIs('login') ? 'active' : '' }}">
                                <i class="bi bi-box-arrow-in-right"></i> Login (Secure)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('register') }}" class="nav-link text-success {{ request()->routeIs('register') ? 'active' : '' }}">
                                <i class="bi bi-person-plus"></i> Register (Secure)
                            </a>
                        </li>
                        {{-- Vulnerable Auth --}}
                        <li class="nav-item">
                            <a href="{{ route('vulnerable.login') }}" class="nav-link text-danger {{ request()->routeIs('vulnerable.login') ? 'active' : '' }}">
                                <i class="bi bi-unlock"></i> Login (Vulnerable)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('vulnerable.register') }}" class="nav-link text-danger {{ request()->routeIs('vulnerable.register') ? 'active' : '' }}">
                                <i class="bi bi-person-plus-fill"></i> Register (Vulnerable)
                            </a>
                        </li>
                        {{-- Demo/Debug --}}
                        <li class="nav-item">
                            <a href="{{ route('vulnerable.show-users') }}" class="nav-link text-warning {{ request()->routeIs('vulnerable.show-users') ? 'active' : '' }}">
                                <i class="bi bi-database"></i> Show DB Users
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('vulnerable.brute-force-stats') }}" class="nav-link text-warning {{ request()->routeIs('vulnerable.brute-force-stats') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse nav-collapse {{ request()->routeIs('file-upload-lab.*') ? 'show' : '' }}" id="fileUploadLab">
                        <li class="nav-item">
                            <a href="{{ route('file-upload-lab.index') }}" class="nav-link {{ request()->routeIs('file-upload-lab.index') ? 'active' : '' }}">
                                <i class="bi bi-house"></i> Overview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('file-upload-lab.overview', 'logging') }}" class="nav-link text-info {{ request()->is('file-upload-lab/overview/logging') ? 'active' : '' }}">
                                <i class="bi bi-journal-text"></i> Logging Materi
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('file-upload-lab.overview', 'upload-basics') }}" class="nav-link text-info {{ request()->is('file-upload-lab/overview/upload-basics') ? 'active' : '' }}">
                                <i class="bi bi-book"></i> Upload Basics
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('file-upload-lab.vulnerable.index') }}" class="nav-link text-danger {{ request()->routeIs('file-upload-lab.vulnerable.*') ? 'active' : '' }}">
                                <i class="bi bi-bug"></i> Vulnerable Lab
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('file-upload-lab.secure.index') }}" class="nav-link text-success {{ request()->routeIs('file-upload-lab.secure.*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse nav-collapse {{ request()->routeIs('security-testing.*') ? 'show' : '' }}" id="securityTesting">
                        <li class="nav-item">
                            <a href="{{ route('security-testing.index') }}" class="nav-link {{ request()->routeIs('security-testing.index') ? 'active' : '' }}">
                                <i class="bi bi-house"></i> Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('security-testing.xss') }}" class="nav-link {{ request()->routeIs('security-testing.xss') ? 'active' : '' }}">
                                <i class="bi bi-shield-exclamation"></i> XSS Test
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('security-testing.csrf') }}" class="nav-link {{ request()->routeIs('security-testing.csrf') ? 'active' : '' }}">
                                <i class="bi bi-key"></i> CSRF Test
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('security-testing.headers') }}" class="nav-link {{ request()->routeIs('security-testing.headers') ? 'active' : '' }}">
                                <i class="bi bi-server"></i> Headers Test
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('security-testing.audit') }}" class="nav-link {{ request()->routeIs('security-testing.audit') ? 'active' : '' }}">
